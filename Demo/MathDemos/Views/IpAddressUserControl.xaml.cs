...
{
    public partial class IpAddressUserControl : Catel.Windows.Controls.UserControl
    {
        ...
        public static readonly DependencyProperty AddressProperty = DependencyProperty.Register("Address", typeof(string),
             typeof(IpAddressUserControl), new FrameworkPropertyMetadata(default(string), OnAddressChanged)
        {
        ...
        {
            var ipTextBox = dependencyObject as IpAddressUserControl;
            ...
            if (text != null && ipTextBox != null)
            {
                ...
                {
                    ipTextBox._segments[i].SetCurrentValue(TextBox.TextProperty, segment);
                    i++;
                }
        ...
        private void TextBoxBase_OnTextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            {
                SetCurrentValue(AddressProperty, string.Format("{0}.{1}.{2}.{3}", FirstSegment.Text, SecondSegment.Text, ThirdSegment.Text, LastSegment.Text));
